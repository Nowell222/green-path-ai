...
import { 
  LayoutDashboard, Shield, Building2, Landmark, Users, BarChart3, Bell, Settings, LogOut, Leaf, ChevronLeft, ChevronRight, Search, ScrollText, Briefcase
} from 'lucide-react';
import { cn } from '@/lib/utils';
import { Input } from '@/components/ui/input';

interface SuperAdminLayoutProps { children: ReactNode; }

const navItems = [
  { path: '/superadmin', label: 'Dashboard', icon: LayoutDashboard },
  { path: '/superadmin/agencies', label: 'Government Agencies', icon: Landmark },
  { path: '/superadmin/hauling-orgs', label: 'Hauling Organizations', icon: Building2 },
  { path: '/superadmin/businesses', label: 'Business Orgs', icon: Briefcase },
  { path: '/superadmin/citizens', label: 'Citizens & Residents', icon: Users },
  { path: '/superadmin/users', label: 'User Directory', icon: Users },
  { path: '/superadmin/analytics', label: 'Analytics', icon: BarChart3 },
  { path: '/superadmin/notifications', label: 'Notifications', icon: Bell },
  { path: '/superadmin/audit-logs', label: 'Audit Logs', icon: ScrollText },
];
        ...
        <header className="sticky top-0 z-40 h-16 bg-card border-b border-border flex items-center justify-between px-6">
          <div className="flex items-center gap-4 flex-1 max-w-md">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search organizations, users..." className="pl-9 bg-background" />
            </div>
          </div>
